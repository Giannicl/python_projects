...
class GardenManager:
    """This is a GardenManager class that has methods to
    add plants, water plants, and check health"""
    ...
    def check_plant_health(plant_name, water_level, sunlight_hours):
        """This function checks if the conditions
        to grow a healthy plant are met"""
        ...
        return print(f"{plant_name}: healthy"
                     "(water: {water_level}, sun: {sunlight_hours})")
