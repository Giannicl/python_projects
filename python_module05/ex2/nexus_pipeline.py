...
def main():
    ...
    print(f"{json_pipeline.pipeline_id} -> {csv_pipeline.pipeline_id} -> {stream_pipeline.pipeline_id}")
    ...
    print(f"\nChain result: {result["records"]} records processed through 3-stage pipeline")
