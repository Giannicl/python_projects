...
class CrewMember(BaseModel):
    ...
    specialization: str = Field(min_length=0, max_length=50)
...
def main() -> None:
    ...
    try:    
        ...
        print("Crew members")
        print(f"- {mission.crew[0].name} ({mission.crew[0].rank.value}) - {mission.crew[0].specialization}")
        print(f"- {mission.crew[1].name} ({mission.crew[1].rank.value}) - {mission.crew[1].specialization}")
        print(f"- {mission.crew[2].name} ({mission.crew[2].rank.value}) - {mission.crew[2].specialization}")
